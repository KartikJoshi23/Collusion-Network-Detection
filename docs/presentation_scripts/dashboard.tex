...
\scripttopic{The Investigator Console}
...
\stage{square brackets} are things you \emph{do} with the mouse, not words you say.
...
% ===========================================================================
\phase{Part 1 --- The opening (2 minutes)}
...
% ===========================================================================
\phase{Part 2 --- The frame around every screen (1 minute 45)}
...
\stage{click the switch} Watch what happens. The colours change. The datasets
...
% ===========================================================================
\phase{Part 3 --- Overview: the opening screen (2 minutes)}
...
% ===========================================================================
\phase{Part 4 --- The Alert Queue: the working screen (4 minutes 30)}
...
Now watch what happens when I get greedy. \stage{drag to 100} A hundred cases, and
it drops to about a quarter. \stage{drag to 200} Two hundred, and it's down to
...
groups, nearly a hundred and fifty are rated ordinary. \stage{click Low} There
they are. Same scoring, same everything. The system simply doesn't think
they're worth your morning.

And I'll be straight about one thing. \stage{switch to contracts} If I flip to
...
% ===========================================================================
\phase{Part 5 --- Graph Explorer: seeing the shape (1 minute 45)}
...
\begin{saythis}
And you can replay it. \stage{press play} The connections light up in order, so
...
% ===========================================================================
\phase{Part 6 --- Case Detail: where a person decides (4 minutes 45)}
...
\begin{saythis}
Let me deliberately open a quiet one from further down the list. \stage{open a low
...
% ===========================================================================
\phase{Part 7 --- Model Lab: the evidence (4 minutes 15)}
...
Four answers. \stage{expand the section}
...
% ===========================================================================
\phase{Part 8 --- About, the assistant, and the close (3 minutes 30)}
...
Let me ask it something ordinary first. \stage{type: which five cases should I look
at first and why?}
...
Now let me try to break it. \stage{type: is firm X guilty?}
...
One more. \stage{type: what will the score be in 2027?} It refuses, and it lists
