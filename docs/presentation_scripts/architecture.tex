...
\do{square brackets} are things you do, not words you say.
...
% ===========================================================================
\part{Part 1 --- Opening (1 minute 15)}

\slide{Slide 1 --- Handing Over --- From The Product To The Machine}{Medium (6/10)}{$\approx$ 35 seconds}

\begin{saythis}
So you've seen what the system does. Now I'll show you how it's actually built,
and I'm \blank.

This is one page. It reads top to bottom like a production line, and everything
you just saw on the console comes out of the bottom of it.

I'll take you down the pipeline first. Then I'll stop at one line in the
middle, which I'd argue is the most important design decision we made. And then
I'll show you what this looks like hosted properly as a real product, with the
bill.
\end{saythis}

\begin{meaning}
This is a handover slide. Its only job is to connect the finished product the
room just saw to the machinery about to appear, and to promise a structure.

Naming the trust boundary as ``the most important decision'' up front makes the
room wait for it, which means they are paying attention when it arrives.
\end{meaning}
...
% ===========================================================================
\part{Part 2 --- Down the pipeline (5 minutes)}
...
% ===========================================================================
\part{Part 3 --- The most important line on the page (1 minute 15)}
...
% ===========================================================================
\part{Part 4 --- Below the line (1 minute 20)}
...
% ===========================================================================
\part{Part 5 --- The method cards (1 minute 30)}
...
% ===========================================================================
\part{Part 6 --- The cloud, and the bill (3 minutes 30)}
